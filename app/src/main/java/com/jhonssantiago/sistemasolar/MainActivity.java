...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    private void criarLista() {
        ...
        Planeta b2 = new Planeta(R.drawable.venus, lista_dados.get(1).toString(), "Vênus é o segundo planeta do Sistema Solar em ordem de distância a partir do Sol, orbitando-o a cada 224,7 dias. Recebeu seu nome em homenagem à deusa romana do amor e da beleza Vénus, equivalente a Afrodite.");
        Planeta b3 = new Planeta(R.drawable.terra, lista_dados.get(2).toString(), "A Terra é o terceiro planeta mais próximo do Sol, o mais denso e o quinto maior dos oito planetas do Sistema Solar. É também o maior dos quatro planetas telúricos. É por vezes designada como Mundo ou Planeta Azul. Lar de milhões de espécies de seres vivos, incluindo os humanos, a Terra é o único corpo celeste onde é conhecida a existência de vida.");
        Planeta b4 = new Planeta(R.drawable.marte, lista_dados.get(3).toString(), "Marte é o quarto planeta a partir do Sol, o segundo menor do Sistema Solar. Batizado em homenagem ao deus romano da guerra, muitas vezes é descrito como o Planeta Vermelho, porque o óxido de ferro predominante em sua superfície lhe dá uma aparência avermelhada.");
        Planeta b5 = new Planeta(R.drawable.jupiter, lista_dados.get(4).toString(), "Júpiter é o maior planeta do Sistema Solar, tanto em diâmetro quanto em massa, e é o quinto mais próximo do Sol. Possui menos de um milésimo da massa solar, contudo tem 2,5 vezes a massa de todos os outros planetas em conjunto. É um planeta gasoso, junto com Saturno, Urano e Netuno.");
        Planeta b6 = new Planeta(R.drawable.saturno, lista_dados.get(5).toString(), "Saturno é o sexto planeta a partir do Sol e o segundo maior do Sistema Solar atrás de Júpiter. Pertencente ao grupo dos gigantes gasosos, possui cerca de 95 massas terrestres e orbita a uma distância média de 9,5 unidades astronômicas.");
        Planeta b7 = new Planeta(R.drawable.urano, lista_dados.get(6).toString(), "Urano é o sétimo planeta a partir do Sol, o terceiro maior e o quarto mais massivo dos oito planetas do Sistema Solar. Foi nomeado em homenagem ao deus grego do céu, Urano.");
        Planeta b8 = new Planeta(R.drawable.netuno, lista_dados.get(7).toString(), "Netuno ou Neptuno é o oitavo planeta do Sistema Solar, o último a partir do Sol desde a reclassificação de Plutão para a categoria de planeta anão, em 2006. Pertencente ao grupo dos gigantes gasosos, possui um tamanho ligeiramente menor que o de Urano, mas maior massa, equivalente a 17 massas terrestres.");
        planetas_l.add(b1);
        planetas_l.add(b2);
        planetas_l.add(b3);
        planetas_l.add(b4);
    ...
    private void preencherAdapter(){
        adapter = new MyAdapter(getApplicationContext(), planetas_l);
